...
-- Legacy compatibility view for existing PHP code that references `students`
CREATE OR REPLACE VIEW students AS
SELECT id,
       tenant_id AS student_id,
       first_name,
       last_name,
       phone,
       email,
...
('admin', 'admin@risetproperties.com', 'Admin', 'User', '+254700000000', '$2y$10$xkhboNPjem90I0GjaxP3h.87yltqOxl1ejNHvG4EOwL.nDSF4gCj.', 'admin', 'Active'),
('landlord', 'landlord@risetproperties.com', 'James', 'Wambua', '+254701234567', '$2y$10$xkhboNPjem90I0GjaxP3h.87yltqOxl1ejNHvG4EOwL.nDSF4gCj.', 'landlord', 'Active'),
('staff', 'staff@risetproperties.com', 'Staff', 'Member', '+254702345678', '$2y$10$xkhboNPjem90I0GjaxP3h.87yltqOxl1ejNHvG4EOwL.nDSF4gCj.', 'staff', 'Active');

-- Insert sample tenants
INSERT INTO tenants (first_name, last_name, phone, email, city, country, tenant_id, date_of_birth, password, status) VALUES
('John', 'Smith', '+254700111111', 'john.smith@example.com', 'Nairobi', 'Kenya', 'ST17241', '1990-06-03', '$2y$10$VWbrkFSo1Q/ACE4p5qo.Y.gUHwPw5ryBvWmbFMPAIM2uzMABRufOK', 'Active'),
('Jane', 'Doe', '+254700222222', 'jane.doe@example.com', 'Nairobi', 'Kenya', 'ST17242', '1987-02-16', '$2y$10$VWbrkFSo1Q/ACE4p5qo.Y.gUHwPw5ryBvWmbFMPAIM2uzMABRufOK', 'Active'),
('Michael', 'Johnson', '+254700333333', 'michael.johnson@example.com', 'Kisumu', 'Kenya', 'ST17243', '1992-06-21', '$2y$10$VWbrkFSo1Q/ACE4p5qo.Y.gUHwPw5ryBvWmbFMPAIM2uzMABRufOK', 'Active');
