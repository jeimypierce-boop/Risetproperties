...
<html lang="en">
<head>
    <title>Billing Invoices - Riset Property Ltd</title>
    <meta charset="utf-8">
            ...
            <div class="sb2-1">
                <div class="sb2-12">
                    <ul>
                        ...
                        <li><h5>Billing Invoices <span>Invoice records</span></h5></li>
                    </ul>
                </div>
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="admin-billing-invoices.php" class="menu-active"><i class="fa fa-file-invoice" aria-hidden="true"></i> Billing Invoices</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#">Billing Invoices</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    ...
                                    <p>View generated invoices and billing history for your agency.</p>
                                </div>
                                <div class="tab-inn">
